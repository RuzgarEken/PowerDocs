...
Power's core package doesn't contain concrete Effector types — you can find ready-to-use Effector implementations in the [General Expansions](/docs/Samples/GeneralExpansions/Effector/index.mdx) package.
