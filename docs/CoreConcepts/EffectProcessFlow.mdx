...
You can find a video tutorial about Effect Types [▶ here](https://youtu.be/0vtKy50Hpyo). 
...
For the following topics, you can find the corresponding video tutorial [▶ here](https://youtu.be/3yMrViborRs?list=PLAVxVgoBmZhM)
