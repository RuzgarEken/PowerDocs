...
import EffectFunnel from '@site/src/components/EffectFunnel';
...
<StatExample
  name="Health"
  relations={[{key: 'NegativeImmune', value: 'ImmuneToNegativeHealthEffects'}]}
/>
...
<ProcessorExample name="BSPrecontributionProcess_Immune" relativeKey="NegativeImmune" />
...
<ProcessorExample name="ASPrecontributionProcess_Immune" relativeKey="Immune_AS" />

`ASPrecontributionProcess_Immune` inspects `PhysicalAttack`'s relationships:

<StatExample
  name="PhysicalAttack"
  relations={[{key: 'Immune_AS', value: 'ImmuneToPhysicalAttack'}]}
/>
