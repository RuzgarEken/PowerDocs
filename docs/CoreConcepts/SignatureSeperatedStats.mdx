...
<FlowChain
  columns={[
    ...
    {
      icon: 'stat',
      label: 'PhysicalAttackReflector',
      sub: 'Signature Separated Stat',
      children: [
...
<FlowChain
  columns={[
    [
      {icon: 'stat', label: 'HealthSteal', sub: 'Reflector'},
      {icon: 'stat', label: 'DamageReflect', sub: 'Reflector'},
    ],
    {icon: 'stat', label: 'SigSep_Float', sub: 'Signature Separated Stats list'},
    {icon: 'container', label: 'Container_SigSep_Float'},
  ]}
/>
