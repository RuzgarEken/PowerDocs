...
See the [Processor naming scheme](/docs/Assets/Processor/ProcessorVariations) for how the signed, separated, and Effector variations are named across every Processor family.
