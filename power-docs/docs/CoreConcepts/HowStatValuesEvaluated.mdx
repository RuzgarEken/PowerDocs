...
Unlike modifiers, Injectors transform a stat's value according to their configuration.
...
**Modified Value**
  ...
  - It is produced by applying all Injectors and Linkers to the Raw Value.
